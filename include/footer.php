    ...
    <div class="row row-gap-30 justify-content-center">
      ...
      <div class="col-lg-2">
        ...
        <ul class="footer-links pl-20">
          <li class="nav-item"><a class="navs" href="./">Home</a></li>
          <li class="nav-item"><a class="navs" href="./about-us.php">About Us</a></li>
          <li class="nav-item"><a class="navs" href="./benefits.php">Benefits</a></li>
          <li class="nav-item"><a class="navs" href="./member.php">Member</a></li>
          <li class="nav-item"><a class="navs" href="./directory.php">Directory</a></li>
        </ul>
      </div>
      <div class="col-lg-3">
        <h4 class="hd-24 mb-15 fw-bold text-white">Contact Info</h4>
        <a href="tel:239-466-3915" class="d-flex align-items-center gap-20">
          <span><i class="fa-solid fa-phone"></i></span>
          <span>239-466-3915</span>
        </a>
        <a href="mailto:Info@scvba.com" class="d-flex align-items-center gap-20">
          <span><i class="fa-solid fa-envelope"></i></span>
          <span>Info@scvba.com</span>
        </a>
        <a href="javascript:;" class="d-flex gap-20">
          <span><i class="fa-solid fa-location-dot"></i></span>
          <span>4758 Sunburst Drive <br>
